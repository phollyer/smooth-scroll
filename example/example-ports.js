...
var $author$project$ExamplePorts$init = function (_v0) {
	return _Utils_Tuple2(
		{animations: $author$project$SmoothMovePorts$init},
		$elm$core$Platform$Cmd$none);
};
var $author$project$ExamplePorts$PositionUpdateMsg = function (a) {
	return {$: 'PositionUpdateMsg', a: a};
};
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$ExamplePorts$positionUpdates = _Platform_incomingPort('positionUpdates', $elm$json$Json$Decode$value);
var $author$project$ExamplePorts$subscriptions = function (model) {
	return $author$project$ExamplePorts$positionUpdates($author$project$ExamplePorts$PositionUpdateMsg);
};
var $elm$json$Json$Encode$string = _Json_wrap;
var $author$project$ExamplePorts$animateElement = _Platform_outgoingPort('animateElement', $elm$json$Json$Encode$string);
...
var $author$project$ExamplePorts$PositionUpdate = F4(
...
var $author$project$ExamplePorts$positionDecoder = A5(
	$elm$json$Json$Decode$map4,
	$author$project$ExamplePorts$PositionUpdate,
...
var $author$project$ExamplePorts$stopElementAnimation = _Platform_outgoingPort('stopElementAnimation', $elm$json$Json$Encode$string);
var $author$project$ExamplePorts$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'MoveToCorner':
				...
				return _Utils_Tuple2(
					...
					$author$project$ExamplePorts$animateElement(
				...
				if (maybeElementId.$ === 'Just') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{animations: newAnimations}),
						$author$project$ExamplePorts$stopElementAnimation(
			...
			default:
				var value = msg.a;
				var _v5 = A2($elm$json$Json$Decode$decodeValue, $author$project$ExamplePorts$positionDecoder, value);
				if (_v5.$ === 'Ok') {
					var posUpdate = _v5.a;
...
var $author$project$ExamplePorts$MoveToCenter = {$: 'MoveToCenter'};
var $author$project$ExamplePorts$MoveToCorner = {$: 'MoveToCorner'};
var $author$project$ExamplePorts$StopAnimation = {$: 'StopAnimation'};
...
var $author$project$ExamplePorts$view = function (model) {
	var position = A2(
		$elm$core$Maybe$withDefault,
		{x: 150, y: 100},
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$ExamplePorts$MoveToCorner)
							]),
						_List_fromArray(
							[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$ExamplePorts$MoveToCenter),
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$ExamplePorts$StopAnimation),
								A2($elm$html$Html$Attributes$style, 'margin-left', '10px')
							]),
						_List_fromArray(
							[
...
var $author$project$ExamplePorts$main = $elm$browser$Browser$element(
	{init: $author$project$ExamplePorts$init, subscriptions: $author$project$ExamplePorts$subscriptions, update: $author$project$ExamplePorts$update, view: $author$project$ExamplePorts$view});
_Platform_export({'ExamplePorts':{'init':$author$project$ExamplePorts$main(
